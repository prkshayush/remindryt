...
export default function Home() {
  return (
    <main className="flex flex-col items-center gap-10 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="my-20 flex flex-col items-center justify-center">
        <h1 className="sm:text-7xl sm:font-bold px-4 py-2 text-3xl font-semibold font-[family-name:var(--font-oregano-sans)]">Smash Deadlines Leverage AI, Win Every Task.</h1>
        ...
        <div>
          ...
          <button className="py-1 px-4 rounded-xl border-b-2 border-r-2 border-green-700 hover:border-blue-600"><a href="#about">Learn More</a></button>
        </div>
      </div>
      <div className="my-28">
        ...
        <p className="sm:text-3xl py-1 px-4 text-center">With <span className='sm:text-4xl font-semibold font-[family-name:var(--font-oregano-sans)]'>RemindRyt</span>, turn task management into a team sport.</p>
      </div>
